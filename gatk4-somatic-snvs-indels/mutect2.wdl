...
workflow Mutect2 {
    ...
    #Boolean run_oncotator_or_default = false
    File? onco_ds_tar_gz
    ...
    Boolean run_funcotator_or_default = false
    ...
    if (run_oncotator_or_default) {
        ...
        call oncotate_m2 {
            input:
                run_oncotator_or_default = run_oncotator_or_default,
...
task oncotate_m2 {
    ...
    String? control_id
    String? oncotator_extra_args
    Boolean? run_oncotator_or_default
