...
지금까지는 유전체 정보는 매우 극소수의 사람들만이 알고 있거나 또는 연구를 위해 정보가 생산되었지만 최근에는 일반 대중들도 DTC(direct-to-consumer) 방식의 유전자검사를 통해 자신이 직접 유전체 정보를 습득할 수 있게 되었다. 해외에서는 이미 수년 전부터 이러한 유전자검사가 대중적으로 가능했지만 국내에서는 이제 막 허용되기 시작했다. 
